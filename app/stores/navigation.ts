    ...
    const navGroups = [
        {
            ...
            items: [
                ...
                { label: 'Animated Input', to: '/docs/components/animated-input', description: 'Input fields with smooth focus and validation animations.' },
                { label: 'Animated Background', to: '/docs/components/animated-background', description: 'Dynamic background elements that react to interaction.' },
                { label: 'Code Block', to: '/docs/components/code-block', description: 'Syntax highlighting with copy functionality and theme support.' },
                { label: 'Bar Visualizer', to: '/docs/components/bar-visualizer', description: 'Audio-reactive bar visualization components.' },
                { label: 'Animated Tabs', to: '/docs/components/animated-tabs', description: 'Tabs with smooth sliding indicators and transitions.' },
        ...
        },
        {
            ...
            icon: ImageIcon,
            items: [
                { label: 'Ambient Grid', to: '/docs/backgrounds/ambient-grid', description: 'Subtle grid background with ambient lighting effects.' },
                { label: 'Background Beams', to: '/docs/backgrounds/background-beams', description: 'Moving beams of light for a cinematic background feel.' },
                { label: 'Dotted Glow', to: '/docs/backgrounds/dotted-glow-background', description: 'A matrix of dots that glow on hover or animation.' },
                { label: 'Gravity Stars', to: '/docs/backgrounds/gravity-stars', description: 'Stars that react to mouse movement and gravity.' },
                { label: 'Ripple Effect', to: '/docs/backgrounds/background-ripple-effect', description: 'Water-like ripple effects triggered by interaction.' },
                { label: 'Snow Effect', to: '/docs/backgrounds/snow-effect', description: 'Configurable snow falling animation.' },
            ]
        },
        {
            title: 'Guide',
            ...
            items: [
                ...
                { label: 'Introduction', to: '/docs/introduction', description: 'Introduction to the design system and philosophy.' },
            ]
        }
    ]
