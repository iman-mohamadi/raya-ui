  ...
  <div class="pb-5">
    ...
    <div class="space-y-12 mt-4">
      ...
      <div class="space-y-4">
        ...
        <p class="text-zinc-400 dark:text-zinc-600 text-sm">Stack tabs vertically using the <code>orientation</code> prop.</p>
        ...
        <Tabs default-value="preview">
          ...
          <TabsContent value="preview">
            <div class="rounded-xl border border-edge bg-background p-6 flex justify-center min-h-[300px]">
      ...
      <div class="space-y-4">
        ...
        <p class="text-zinc-400 dark:text-zinc-600 text-sm">A minimal underline style, perfect for sub-navigation.</p>
        ...
        <Tabs default-value="preview">
          ...
          <TabsContent value="preview">
            <div class="rounded-xl border border-edge bg-background p-10 flex justify-center min-h-[150px]">
              <div class="w-full max-w-md">
      ...
      <div class="space-y-4">
        ...
        <p class="text-zinc-400 dark:text-zinc-600 text-sm">Use <code>v-model</code> to control the active tab programmatically.</p>
        ...
        <Tabs default-value="preview">
          ...
          <TabsContent value="preview">
            <div class="rounded-xl border border-edge bg-background p-10 flex flex-col items-center gap-6 min-h-[200px]">
      ...
      <div class="space-y-4">
        ...
        <div class="rounded-xl border border-edge bg-background p-10 flex justify-center overflow-hidden">
          <div class="w-[350px]">
