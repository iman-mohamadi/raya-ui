...
// Aligning with the new layout strategy
...
<template>
  <NuxtLayout name="default">
    <div class="max-w-7xl mx-auto">
      ...
      <!-- Header Section -->
      <header class="mb-16">
        <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 border border-primary/20 text-primary text-[10px] font-black tracking-widest uppercase mb-4">
          Inventory
        </div>
          ...
          >
            ...
            >
              ...
              >
                ...
                <div class="aspect-[4/3] relative flex items-center justify-center overflow-hidden bg-background/50 border-b border-border/30">
                ...
                <div class="p-6 flex flex-col flex-1">
                  <div class="flex items-center justify-between mb-2">
                    ...
                    <ArrowRight class="size-3 text-muted-foreground -translate-x-2 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all" />
                  </div>
