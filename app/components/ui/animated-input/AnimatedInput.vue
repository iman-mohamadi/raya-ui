...
const props = withDefaults(defineProps<{
  ...
  glowColor: '#14b8a6' // Default to Raya Teal
})
...
<template>
  ...
  >
    <input
        ...
        v-model="modelValue"
        :class="cn(
        'flex h-10 w-full border-none bg-gray-50 dark:bg-zinc-900 text-black dark:text-white shadow-input rounded-md px-3 py-2 text-sm',
